...
(function(factory) {
    ...
    var isString = function kt(n){return typeof n=="string"||n&&typeof n=="object"&&ce.call(n)==P||false};
   ...
   ********************/
        ...
        _initFocusListeners: function() {
            ...
            this.telInput.on("blur" + this.ns, function() {
                if (that.options.autoHideDialCode) {
                    ...
                    var value = that.telInput.val(), startsPlus = isString(value) ? value.charAt(0) == "+" : false;
                    if (startsPlus) {
        ...
        _updateVal: function(val, addSuffix, preventConversion, isAllowedKey) {
            ...
            if (this.options.autoFormat && window.intlTelInputUtils) {
                ...
                if (!preventConversion && this.options.nationalMode && isString(val) && val.charAt(0) == "+" && intlTelInputUtils.isValidNumber(val, this.selectedCountryData.iso2)) {
        ...
        _updateFlagFromNumber: function(number) {
            ...
            if (this.options.nationalMode && this.selectedCountryData && this.selectedCountryData.dialCode == "1" && isString(number) && number.charAt(0) != "+") {
            ...
            } else if (isString(number) && number.charAt(0) == "+") {
        ...
        _updateDialCode: function(newDialCode, focusing) {
            ...
            if (this.options.nationalMode && isString(inputVal) && inputVal.charAt(0) != "+") {
                ...
                if (prevDialCode.length > 1) {
                    ...
                    var existingNumber = "";
                    if (isString(inputVal)) inputVal.charAt(0) != "+" ? $.trim(inputVal) : "";
        ...
        _getDialCode: function(number) {
            ...
            if (isString(number) && number.charAt(0) == "+") {
                var numericChars = "";
                // iterate over chars
   ...
   ********************/
        ...
        setNumber: function(number, addSuffix, preventConversion, isAllowedKey) {
            ...
            if (!this.options.nationalMode && isString(number) && number.charAt(0) != "+") {
                number = "+" + number;
            }
